            ...
            <section className="p-4 max-w-6xl mx-auto">
                <div className=" flex gap-2 justify-end mb-2 max-w-6xl mx-auto">
                    ...
                    <Link href={"/dashboard/accounts/invoice/Cash_&_Bank"}>
                        <button type="button" className="capitalize flex items-center focus:outline-none text-white bg-green-600 hover:bg-green-600 focus:ring-green-600 font-medium rounded-lg text-sm px-5 py-2  ">
                            Cash & Bank
                        </button>
                    </Link>
                </div>
