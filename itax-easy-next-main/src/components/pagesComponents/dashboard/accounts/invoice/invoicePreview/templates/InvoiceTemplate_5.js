	...
	return (
        <div>
            <div className="p-2 grid gap-2 md:grid-cols-2 my-2 divide-y-2 md:divide-y-0">
                <div>
                    <div className="mt-2 text-xl bg-red-400 text-neutral-50 px-2 font-semibold">Details: </div>
                    {watch("details")}
                </div>
                <div>
                    <div className="mt-2 text-xl bg-red-400 text-neutral-50 px-2 font-semibold">Extra Details: </div>
                    {watch("extraDetails")}
                </div>
            </div>
            <div className="p-2">
