    ...
    return (
        <>
            <div className={`
                    ...
                    pb-[50px]
                    scrollbar-thin
                 overflow-hidden z-50 fixed top-0 bottom-0 bg-neutral-50 text-blue-500 h-full
                 ${isSidebarOpen ? "-translate-x-[0%] md:w-64" : "md:-translate-x-[0%] -translate-x-full md:w-16"} w-64 transition-all duration-200`}>
                <SidebarToggle
