  ...
  console.log(nexttaxablevalue(1000000)); // Output will be 112500
    ...
    return (
        <div className="p-4 space-y-8">
            ...
            <p className="paragraph-xs">Placeholders can be used to enhance the experience of your application. {"They're"} built only with HTML and CSS, meaning you {"don't"} need any JavaScript to create them. You will, however, need some custom JavaScript to toggle their visibility. Their appearance, color, and sizing can be easily customized with our utility classes.</p>
            <p className="paragraph-sm">Placeholders can be used to enhance the experience of your application. {"They're"} built only with HTML and CSS, meaning you {"don't"} need any JavaScript to create them. You will, however, need some custom JavaScript to toggle their visibility. Their appearance, color, and sizing can be easily customized with our utility classes</p>
            <p className="paragraph-md">Placeholders can be used to enhance the experience of your application. {"They're"} built only with HTML and CSS, meaning you {"don't"} need any JavaScript to create them. You will, however, need some custom JavaScript to toggle their visibility. Their appearance, color, and sizing can be easily customized with our utility classes.</p>
            <p className="paragraph-lg">Placeholders can be used to enhance the experience of your application. {"They're"} built only with HTML and CSS, meaning you {"don't"} need any JavaScript to create them. You will, however, need some custom JavaScript to toggle their visibility. Their appearance, color, and sizing can be easily customized with our utility classes</p>
            <p className="paragraph-xl">TPlaceholders can be used to enhance the experience of your application. {"They're"} built only with HTML and CSS, meaning you {"don't"} need any JavaScript to create them. You will, however, need some custom JavaScript to toggle their visibility. Their appearance, color, and sizing can be easily customized with our utility classes</p>
            <p className="paragraph-2xl">Placeholders can be used to enhance the experience of your application. {"They're"} built only with HTML and CSS, meaning you {"don't"} need any JavaScript to create them. You will, however, need some custom JavaScript to toggle their visibility. Their appearance, color, and sizing can be easily customized with our utility classes</p>
            ...
            <div className="grid lg:grid-cols-2">
                <div>
                    ...
                    <form action="">
                        <input type="text" />
                        <button className="inline-block px-6 py-2 rounded-md text-neutral-50 bg-blue-500 hover:bg-blue-600" type="submit">Submit</button>
                    </form>
                </div>
                <div>
                    <div class="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800">
