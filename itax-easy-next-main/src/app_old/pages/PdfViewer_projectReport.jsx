...
export default function PdfViewer_projectReport() {
  ...
  const businessName = state.pdfDocReport.businessName;
  const intro = state.pdfDocReport.intro;
  const loan = state.pdfDocReport.loan;
  const owner = state.pdfDocReport.owner;
  const pnmList = state.pdfDocReport?.pnmList;
  const rented = state.pdfDocReport.rented;
  const data = state.pdfDocReport?.data;

  useEffect(() => {
    if (!state.pdfDocReport?.businessName) {
  ...
  return (
    <>
      {state.pdfDocReport?.businessName && (
