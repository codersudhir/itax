        ...
        >
          ...
          <div className="flex flex-col relative">
            <input
              ...
              id="name"
              className="-bg--clr-neutral-200  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-200 duration-300   border -border--clr-neutral-200 -text--clr-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div className="flex flex-col sm:flex-row gap-2 lg:[&>div]:basis-1/2 items-center lg:flex-row ">
            <div className="flex w-full mx-2">
              ...
              <select
                className=" -bg--clr-neutral-200  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-200 duration-300 border -border--clr-neutral-200 -text--clr-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/2 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                name="gender"
                id="gender"
          ...
          <div className="flex items-center gap-8">
            ...
            <div>
              <input
                ...
                name="cv"
                id="name"
                className="block w-full text-sm -text--clr-neutral-900  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gray-200 duration-300 border -border--clr-neutral-200 rounded-lg cursor-pointer -bg--clr-neutral-200 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
