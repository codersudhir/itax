...
export default function Searchbypan() {
	...
	const getSateCode = async () => {
		await axios
			.get(`https://cdn.jsdelivr.net/gh/refrens/gst-states/index.json`)
			.then(function (response) {
				setStateCode(response.data);
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                        ...
                        <div>
                            ...
                            >
                            <option value={selectStateCode} selected>
                                Select State
                            </option>
                            {Object?.keys(stateCode)?.map((key) => (
