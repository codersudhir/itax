...
const Newcostinflationindex = () => {
  const conponentPDF = useRef();
  const generatePDF = useReactToPrint({
    content: () => conponentPDF.current,
    documentTitle: "Newcostinflationindex itaxeasy",
  });
  return (
    <>
        ...
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            <div class="overflow-x-auto">
              <h5 className="text-center my-5">New cost inflation index</h5>
                ...
                >
                  ...
                  <tbody>
                    <tr className="h-10 text-left">
                      ...
                      <td className="border border-gray-300 p-2">2001-02 </td>
                    ...
                    <tr className="h-10 text-left">
                      ...
                      <td className="border border-gray-300 p-2"> 2006-7</td>
