  ...
  return (
    <>
      <div className="container m-10">
        <h1 className=" text-center heading-5">E-Library</h1>
                ...
                <>
                  ...
                  >
                    ...
                    <td className="border border-gray-300 p-2">
                      <button
                        type="button"
                        class="px-3 py-2  text-white bg-blue-500 hover:bg-blue-600 hover:scale-105 transition-[transform,_colors] duration-300 text-xs font-medium text-center inline-flex items-center   rounded-lg  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                ...
                {currdata.map((element) => {
                  return (
                    <>
                      ...
                      <div className="mx-20">
                        <h1 className="heading-6 text-center">Conclusion</h1>
                        <hr class="border-gray-200 dark:border-white"></hr>
