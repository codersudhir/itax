...
const About = () => {
  return (
    <>
      <div className="bt-green-50 rounded-4xl text-2xl container mx-auto ">
        <div
          className="header text-center text-5xl font-serif pt-28 "
          style={{ fontSize: "3rem", textShadow: "0 4px 6px rgb(0 0 0 / 30%)" }}
        >
          About Us
        </div>
        <div
          className="header2 text-center text-xl font-serif pt-3 "
          style={{ textShadow: "0 4px 6px rgb(0 0 0 / 30%)" }}
        >
          Know Who We Are
        </div>
      </div>
      <div className="container mx-auto mt-10 ">
        <div className="grid md:grid-cols-2 sm:grid-cols-1 ">
          <div>
            <img src="images/aboutt.jpg" alt="about_image" />
          </div>
          <div>
      ...
      <div>
        <div>
          ...
          <div className=" relative container mx-auto shadow-lg rounded-xl grid my-20 md:grid-cols-2 sm:grid-cols-1 gap-4 ">
            ...
            <div className="mission px-20 py-44 ">
        ...
        <div>
          <div className=" our vision header text-center text-5xl font-serif pt-28 ">
            Our Vision
          </div>
          <div className="header2 text-center text-xl font-serif pt-3 ">
          ...
          <div className=" relative container mx-auto shadow-lg rounded-xl grid my-20 md:grid-cols-2 sm:grid-cols-1 gap-4 ">
            ...
            <div className="vision_image">
              <img width={500} src="images/grow.png" className="" />
            </div>
            <div className="vision p-20 ">
              A mission statement is typically longer and more detailed than a
              vision statement and should be specific, measurable and most
              importantly actionable.For example, a finance company&apos;s
              mission statement may be to &quot;provide accessible and
