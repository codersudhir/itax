          ...
          <div className="mx-auto max-w-4xl w-full">
            <div className="md:grid md:grid-cols-2 flex flex-col px-4 gap-5">
              ...
              <div className="flex flex-col">
                ...
                />
                <ErrorMessage component="span" className="text-red-500" name="ifscCodeOfYourBranch" />
              </div>
              <div className="flex flex-col">
            ...
            <div>
              <FieldArray
                ...
                render={(arrayHelpers) => {
                  const allOtherBankAccounts = values.allOtherBankAccounts;
                  return (
                    <>
                      {allOtherBankAccounts.map((items, index) => (
                        <div
                          key={index}
            ...
            <div className="md:grid md:grid-cols-2 flex flex-col px-4 gap-5">
              ...
              <div className="flex flex-col">
                <label htmlFor="stdCode" className={InputStyles.label}>
                  STD code
                </label>
                <Field
                  type="text"
            ...
            <div className="flex mt-10">
              <button type="submit" className="transition-colors bg-primary hover:bg-blue-950 px-16 py-3 text-white rounded-md font-semibold text-sm cursor-pointer col-span-2 mx-auto">
                Save
              </button>
            </div>
          </div>
